...
export function Metrics({ releasedDayCount, totalDayCount, statusText, metrics }: MetricsProps) {
  return (
    <section className="grid items-start gap-4 md:grid-cols-4">
      <article className="rounded-[1.75rem] bg-slate-950 p-5 text-white shadow-[0_20px_60px_-35px_rgba(15,23,42,0.95)]">
        <div className="flex items-start justify-between gap-4">
          <div className="min-w-0">
            <p className="text-sm uppercase tracking-[0.18em] text-slate-400">Progress</p>
